...
class SimpleNewsBot:
    def __init__(self):
        self.bot_token = os.getenv('BOT_TOKEN', '8425355916:AAGc6-zek0min7lTD4qg4OHly5pdTw15cZI')
        self.channel_id = os.getenv('CHANNEL_ID', '@ne77i')
...
➖➖➖➖➖➖➖➖➖➖
    ...
    async def run_once(self):
        ...
        try:
            ...
            # جمع‌آوری اخبار   news_items = await self.collect_all_news()
